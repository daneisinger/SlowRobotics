...
namespace Toxiclibs.core
{
    ...
    public class Matrix4x4
    {
        ...
        public Matrix4x4(double[] array)
        {
            ...
            {
                throw new SystemException("Array.Length must == 9 or 16");
            }
            init();
            if (array.Length == 16)
            {
        ...
        {
            return new Matrix4x4(this).scaleSelf(scale.getX(), scale.getY(), scale.getZ());
        }
        ...
        public Matrix4x4 setPerspective(double fov, double aspect, double near,
                double far)
        {
            double y = near * Math.Tan(0.5 * Math.PI * fov / 180.0);
            double x = aspect * y;
        ...
        {
            return new Matrix4x4(this).translateSelf(trans.getX(), trans.getY(),
                    trans.getZ());
        }
        ...
        {
            return translateSelf(trans.getX(), trans.getY(), trans.getZ());
        }
